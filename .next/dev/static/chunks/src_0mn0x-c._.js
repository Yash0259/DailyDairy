...
function cloneState(state) {
    return {
        ...
        weakList: state.weakList.map((item)=>({
                ...item
            }))
    };
}
...
function mergeHabit(baseHabit, localHabit, remoteHabit) {
...
function mergeStates(baseState, localState, remoteState) {
    ...
    const baseHabits = new Map(baseState.habits.map((habit)=>[
            habit.id,
            habit
        ]));
    const localHabits = new Map(localState.habits.map((habit)=>[
            habit.id,
            habit
        ]));
    const mergedHabitIndex = new Map(mergedState.habits.map((habit, index)=>[
            habit.id,
            index
        ]));
    const baseWeakList = new Map(baseState.weakList.map((item)=>[
            item.id,
            item
        ]));
    const localWeakList = new Map(localState.weakList.map((item)=>[
            item.id,
            item
        ]));
    const mergedWeakListIndex = new Map(mergedState.weakList.map((item, index)=>[
            item.id,
            index
        ]));
    ...
    for (const localWeakItem of localState.weakList){
        const baseWeakItem = baseWeakList.get(localWeakItem.id);
        const mergedIndex = mergedWeakListIndex.get(localWeakItem.id);
        if (!baseWeakItem) {
            if (mergedIndex === undefined) {
                mergedState.weakList.push({
                    ...localWeakItem
                });
            }
            continue;
        ...
        const remoteWeakItem = mergedState.weakList[mergedIndex];
        const mergedWeakItem = {
            ...remoteWeakItem
        };
        if (localWeakItem.weakness !== baseWeakItem.weakness) {
            mergedWeakItem.weakness = localWeakItem.weakness;
        }
        if (localWeakItem.futureHabit !== baseWeakItem.futureHabit) {
            mergedWeakItem.futureHabit = localWeakItem.futureHabit;
        }
        if (localWeakItem.note !== baseWeakItem.note) {
            mergedWeakItem.note = localWeakItem.note;
        }
        if (localWeakItem.createdAt !== baseWeakItem.createdAt) {
            mergedWeakItem.createdAt = localWeakItem.createdAt;
        }
        mergedState.weakList[mergedIndex] = mergedWeakItem;
    }
    mergedState.weakList = mergedState.weakList.filter((item)=>localWeakList.has(item.id) || !baseWeakList.has(item.id));
    return mergedState;
}
...
function App() {
    ...
    const hasSyncedOnce = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const backendStatusRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])('loading');
    ...
    const saveQueuedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const localChangePendingRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "App.useEffect": ()=>{
            ...
            async function refreshFromServer() {
                ...
                try {
                    ...
                    if (!statesEqual(remoteState, lastSyncedStateRef.current)) {
                        ...
                        window.localStorage.setItem(STORAGE_KEY, JSON.stringify(remoteState));
                        setStoredState({
                            "App.useEffect.refreshFromServer": (current)=>statesEqual(current, remoteState) ? current : remoteState
                        }["App.useEffect.refreshFromServer"]);
                    }
                    setBackendStatus('connected');
                } catch  {
                    if (active) {
            ...
            const intervalId = window.setInterval({
                "App.useEffect.intervalId": ()=>{
                    void refreshFromServer();
                }
            }["App.useEffect.intervalId"], SYNC_POLL_INTERVAL_MS);
            const handleVisibility = {
                "App.useEffect.handleVisibility": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "App.useEffect": ()=>{
                    ...
                    const flushSave = {
                        "App.useEffect.flushSave": async ()=>{
                            ...
                            try {
                                ...
                                setStoredState({
                                    "App.useEffect.flushSave": (current)=>statesEqual(current, mergedState) ? current : mergedState
                                }["App.useEffect.flushSave"]);
                                setBackendStatus('connected');
                            } catch  {
                                setBackendStatus('offline');
                            } finally{
            ...
            }["App.useEffect"], hasSyncedOnce.current ? 250 : 0);
            return ({
                "App.useEffect": ()=>{
                    if (saveTimer.current !== null) {
                        window.clearTimeout(saveTimer.current);
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                        children: backendStatus === 'connected' ? 'Live' : backendStatus === 'saving' ? 'Syncing' : 'Offline'
                                    }, void 0, false, {
                                        fileName: "[project]/src/App.tsx",
                                        lineNumber: 1194,
                                        columnNumber: 13
...
_s(App, "uecaRJ144ccax6ddlPja7aTFWmU=");
_c1 = App;
...
//# sourceMappingURL=src_0mn0x-c._.js.map